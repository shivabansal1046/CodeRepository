...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
  ...
  <tr>
	...
	&nbsp;&nbsp;&nbsp;&nbsp; <a href="http://HYD2-7200013317.ant.amazon.com:8080/DW__MAP_MGMT_SYS/AddTblInfoStart.jsp">Create New Table</a><br>
      	...
      	&nbsp;&nbsp;&nbsp;&nbsp; <a href="http://HYD2-7200013317.ant.amazon.com:8090/DW__MAP_MGMT_SYS/UpdateTableInfoStart.jsp">Modify Existing Table</a><br>

      	&nbsp;&nbsp;&nbsp;&nbsp; <a href="http://HYD2-7200013317.ant.amazon.com:8090/DW__MAP_MGMT_SYS/ViewTblInfoStart.jsp">View Tables</a><br>

      	&nbsp;&nbsp;&nbsp;&nbsp; <a href="http://HYD2-7200013317.ant.amazon.com:8090/DW__MAP_MGMT_SYS/ModColInfo.jsp">Add New Columns to table</a><br>

      	&nbsp;&nbsp;&nbsp;&nbsp; <a href="http://HYD2-7200013317.ant.amazon.com:8090/DW__MAP_MGMT_SYS/UpdateColInfoStart.jsp">Modify Existing Columns</a><br>

      	&nbsp;&nbsp;&nbsp;&nbsp; <a href="http://HYD2-7200013317.ant.amazon.com:8090/DW__MAP_MGMT_SYS/ViewTableColumnsStart.jsp">View Columns For a Table</a></font></b></p>
      	&nbsp;&nbsp;&nbsp;&nbsp; <a href="http://HYD2-7200013317.ant.amazon.com:8090/DW__MAP_MGMT_SYS/ViewTableColumnsStartAll.jsp">View All For a Table</a></font></b></p>
      	&nbsp;&nbsp;&nbsp;&nbsp; <a href="http://HYD2-7200013317.ant.amazon.com:8090/DW__MAP_MGMT_SYS/ETLTraceQueryStart.jsp">Column ETL tracking</a></font></b></p>
...
<td><strong>SRC_ETL_LYR</strong> </td>
<td><strong>SRC1_TBL_NM</strong> </td>
<td><strong>SRC1_COL_NM</strong> </td>
<td><strong>SRC_COL_BUS_LOGIC</strong> </td>
<td><strong>SRC1_ETL_LYR</strong> </td>
</tr>
</table>
	      ...
	      for(var j=0;j<arr.length;j++)
	            {
	    	        ...
	    	        var colDet = new Array();
    	  		    colDet = colum.split('|');
    	  		  	if(colDet !='undefined')
	    	  		addRow(colDet[0],colDet[1],colDet[2],colDet[3],colDet[4],colDet[5],colDet[6],colDet[7],colDet[8],colDet[9],colDet[10]);
...
function addRow(PHYS_TBL_NM,PHYS_COL_NM,ETL_LYR,SRC_TBL_NM,SRC_COL_NM,COL_BUS_LOGIC,SRC_ETL_LYR,SRC1_TBL_NM,SRC1_COL_NM,SRC_COL_BUS_LOGIC,SRC1_ETL_LYR)
{
          ...
          addCell(2,'input','text','ETL_LYR','ETL_LYR',20,20,i,row,ETL_LYR);
          addCell(3,'input','text','SRC_TBL_NM','SRC_TBL_NM',20,20,i,row,SRC_TBL_NM);
          addCell(4,'input','text','SRC_COL_NM','SRC_COL_NM',20,20,i,row,SRC_COL_NM);
          addCell(5,'input','text','COL_BUS_LOGIC','COL_BUS_LOGIC',20,20,i,row,COL_BUS_LOGIC);
          addCell(6,'input','text','SRC_ETL_LYR','SRC_ETL_LYR',20,20,i,row,SRC_ETL_LYR);
          addCell(7,'input','text','SRC1_TBL_NM','SRC1_TBL_NM',20,20,i,row,SRC1_TBL_NM);
          addCell(8,'input','text','SRC1_COL_NM','SRC1_COL_NM',20,20,i,row,SRC1_COL_NM);
          addCell(9,'input','text','SRC_COL_BUS_LOGIC','SRC_COL_BUS_LOGIC',20,20,i,row,SRC_COL_BUS_LOGIC);
          addCell(10,'input','text','SRC1_ETL_LYR','SRC1_ETL_LYR',20,20,i,row,SRC1_ETL_LYR);
